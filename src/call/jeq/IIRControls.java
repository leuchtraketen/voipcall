...
/**
 * Constols of equalizer Author: Dmitry Vaguine Date: 02.05.2004 Time: 12:00:29
 */
public class IIRControls {
	/**
	 * Volume gain values should be between 0.0 and 1.0
	 */
	...
	void setBandDbValue(int band, int channel, float value) {
		...
		/* -12dB .. 12dB mapping */
		bands[band][channel] = (float) (2.5220207857061455181125E-01 * Math
				.exp(8.0178361802353992349168E-02 * value) - 2.5220207852836562523180E-01);
	}
	...
	public void setPreampDbValue(int channel, float value) {
		/* -12dB .. 12dB mapping */
		preamp[channel] = (float) (9.9999946497217584440165E-01 * Math
				.exp(6.9314738656671842642609E-02 * value) + 3.7119444716771825623636E-07);
	}
}
